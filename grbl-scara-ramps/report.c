...
void report_grbl_settings() {
  // Print Grbl settings.
	...
	printPgmString(PSTR("\r\n$28=")); printFloat_SettingValue(settings.scara_arm1);
	printPgmString(PSTR("\r\n$29=")); printFloat_SettingValue(settings.scara_arm2);
	printPgmString(PSTR("\r\n$30=")); printFloat_SettingValue(settings.scara_theta);
	printPgmString(PSTR("\r\n$31=")); printFloat_SettingValue(settings.scara_psi);
	printPgmString(PSTR("\r\n"));
	...
	printPgmString(PSTR(" (length 1 (from motor side)  /SCARA, mm)\r\n$29="));printFloat_SettingValue(settings.scara_arm2);
	printPgmString(PSTR(" (length 2 (from the ballpoint pen side)/SCARA, mm)\r\n$30=")); printFloat_SettingValue(settings.scara_theta);
	printPgmString(PSTR(" (angle theta /SCARA)\r\n$31="));printFloat_SettingValue(settings.scara_psi);
	printPgmString(PSTR(" (angle psi /SCARA)\r\n")); 
