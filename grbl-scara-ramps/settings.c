...
void settings_restore(uint8_t restore_flag) {
    if (restore_flag & SETTINGS_RESTORE_DEFAULTS) {
        ...
        settings.scara_arm1=DEFAULT_SCARA_ARM1;
        settings.scara_arm2=DEFAULT_SCARA_ARM2;
        settings.scara_theta=DEFAULT_SCARA_THETA;
        settings.scara_psi=DEFAULT_SCARA_PSI;
    ...
    if (parameter >= AXIS_SETTINGS_START_VAL) {
            ...
            if (parameter < N_AXIS) {
                ...
                switch (set_idx) {
                    ...
                    case 1:
                        ...
                        break;
                    case 2: settings.acceleration[parameter] = value * 60 * 60;
                        break; // Convert to mm/min^2 for grbl internal use.
                    case 3: settings.max_travel[parameter] = -value;
        ...
        switch (parameter) {
            case 0:
                ...
                break;
            case 1: settings.stepper_idle_lock_time = int_value;
                break;
            case 2:
            ...
            case 10: settings.status_report_mask = int_value;
                break;
            case 11: settings.junction_deviation = value;
                break;
            case 12: settings.arc_tolerance = value;
                break;
            case 13:
                if (int_value) {
                    settings.flags |= BITFLAG_REPORT_INCHES;
            ...
            case 22:
                ...
                break;
            case 23: settings.homing_dir_mask = int_value;
                break;
            case 24: settings.homing_feed_rate = value;
                break;
            case 25: settings.homing_seek_rate = value;
                break;
            case 26: settings.homing_debounce_delay = int_value;
                break;
            case 27: settings.homing_pulloff = value;
                break;
            case 28: settings.scara_arm1 = value; 
                break;
            case 29: settings.scara_arm2 = value; 
                break;
            case 30: settings.scara_theta = value; 
                break;
            case 31: settings.scara_psi = value; 
                break;
